...
const DotField = memo(
  ({
    ...
    sparkle = false,
    waveAmplitude = 0,
    gradientFrom = 'rgba(97, 175, 239, 0.35)',
    gradientTo = 'rgba(198, 120, 221, 0.25)',
    glowColor = '#1e222a',
    ...
    return (
      <div className={`absolute inset-0 w-full h-full ${className}`} style={{ background: backgroundColor }}>
        <canvas
          ref={canvasRef}
          style={{
            position: 'absolute',
